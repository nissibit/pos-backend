...
<div id="msgInstallWCPP" style="display:none;">
    ...
    <p>
        <a href="{{action('HomeController@printHtmlCard')}}" >You can go and test the printing page...</a>
    </p>
...
//            window.location.href = '{{action('HomeController@printHtmlCard')}}';
            window.location.href = "{{ route('printdirect') }}";
