<div class="row">
    <div class="form-group col btn-group-sm">
        <a href="{{ route('partner.create') }}" class="btn btn-outline-secondary">
    ...
    <div class="form-group col input-group-sm">
        <form id="partner_search" role="form" autocomplete="off" action="{{ route('partner.search') }}" method="post" class="m-sm-1">
            {{ csrf_field() }}
