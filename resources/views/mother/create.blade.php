...
<div class="card">
    <div class="card-header">
        <i class="fa fa-user fa-plus-circle"> Registar Produto Principal</i>
    </div>

    <div class="card-body">
        <form class="form-horizontal" method="POST" action="{{ route('mother.store') }}">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-sm-6 form-group input-group-sm">
                    ...
                    <input type="checkbox" name="generate_barcode" id="generate_barcode"  checked="true" />
                ...
                <div class="col-sm-6 form-group input-group-sm">
                    ...
                    <input type="checkbox" name="generate_othercode" id="generate_othercode" checked="true" />
            ...
            <div class="row">
                ...
                <div class="col-sm-6 form-group input-group-sm">
                    ...
                    <select class="form-control @error('unity_id') is-invalid @enderror" name="unity_id" id='unity_id'>
                        ...
                        <option value="{{ $unity->id }}" {{ old('unity_id', $dados['unity_id'] ?? '') == $unity->id ? 'selected' : '' }}>  {{ $unity->name. ' ('.$unity->label.')' }}</option>                    
                        @endforeach
                    </select>
                    @error('unity_id')
                    <span class="invalid-feedback" role="alert">
            ...
            <div class="row">
                <div class="row col">
                    ...
                    <div class="col form-group input-group-sm">
                        ...
                        <input id="margem" type="text" class="form-control @error('margem') is-invalid @enderror" name="margem" value="{{ old('margem', $product->margem ?? '20') }}"  onkeyup="findPrice()" >                        
                    </div>
                </div>
                <div class="col">
                <div class="col form-group input-group-sm">
                    <label for="price" class="control-label">Preco de venda (com taxa) <b class="text-danger">*</b></label>
                    <input id="price" type="text" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ old('price', $product->price ?? '1') }}" onkeyup="calMargem()"  >
                    @error('price')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="row">
                <div class="col-sm-6 form-group input-group-sm d-none">
                ...
                <div class="col form-group input-group-sm">
                    <label for="stock" class="control-label">Stock <b class="text-danger">*</b></label>
                    <input id="quantity" type="text" class="form-control @error('quantity') is-invalid @enderror" name="quantity" value="{{ old('quantity', $product->quantity ?? '') }}" required="" >
                    @error('quantity')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
