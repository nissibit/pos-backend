                ...
                @endif
                    <form class="form-horizontal" method="POST" action="{{ route('company.store') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="name" value="{{ $company->name }}" readonly="readonly" >
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group{{ $errors->has('label') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="alias" type="text" class="form-control" name="alias" value="{{ $company->label }}"  readonly="readonly" >
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" type="description" class="form-control" name="description" readonly="readonly">{{ $company->description }}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('created_at') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="created_at" type="created_at" class="form-control" name="created_at" readonly="readonly">{{ $company->created_at }}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('updated_at') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="updated_at" type="updated_at" class="form-control" name="updated_at" readonly="readonly">{{ $company->updated_at }}</textarea>
