<div class="row">
    <div class="form-group col btn-group-sm">
        ...
        @endcan         
        @can("set_role")
        <a href="{{ route('role.set') }}" class="btn btn-outline-secondary">
            <i class="fas fa-check"> perfil</i>
        </a>
        @endcan         
        @can("listset_role")
    ...
    <div class="form-group col">
        @can("pesquisa_role")
        <form id="role_pesquisar" role="form" autocomplete="off" action="{{ route('role.pesquisar') }}" method="get">
