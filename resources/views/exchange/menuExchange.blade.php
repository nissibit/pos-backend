<div class="row">
    <div class="form-group col btn-group-sm">
        ...
        <a href="{{ route('exchange.index') }}" class="btn btn-outline-secondary  ml-1">
            <i class="fas fa-list"> listar</i>
        </a>
    </div>
    <div class="form-group col input-group-sm">
        <form id="exchange_search" role="form" autocomplete="off" action="{{ route('exchange.search') }}" method="get" class="m-sm-1">
