<div class="row">
    <div class="form-group col btn-group-sm">
        ...
        @endcan  
        <a href="{{ route('cashflow.index') }}" class="btn btn-outline-secondary ml">
            <i class="fas fa-list"> listar</i>
        </a>

    </div>
    <div class="form-group col input-group-sm">
        <form id="unity_search" role="form" autocomplete="off" action="{{ route('cashflow.search') }}" method="get" class="m-sm-1">            
