<div class="col-sm-2 sidenav" style="background-color: transparent;">
    <div class="list-group text-left">
        ...
        @can("menu_aluno")<a href="#" class="list-group-#"><i class="fa fa-user-circle-o"> Aluno</i></a>@endcan
        @can("menu_professor")<a href="#" class="list-group-#"><i class="fa fa-users-cog"> Professor</i></a>@endcan
        @can("menu_encarregado")<a href="#" class="list-group-#"><i class="fa fa-group"> Encarregado</i></a>@endcan
