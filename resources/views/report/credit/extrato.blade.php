<html>
    ...
    <body>
        ...
        <main>
            @php
            $credits = $account->credits()->latest()->get();
            $total = 0;
            @endphp
            ...
            <table style="width: 100%; padding: 2px; font-size: 8pt">
                <tr>
                    ...
                    <td colspan="2">&nbsp;</td>
                    <td colspan="2" style="text-align: right"><strong>Extrato</strong>
                </tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">{{ $credit->PAYED ? 'SIM' : 'NÃO' }}</td>
                    </tr>
                    @php
                    $total += $credit->total;
                    @endphp
                    @empty
                    <tr>
                        <td colspan="6" style="text-align:center"> Sem registos ...</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
            ...
            <div style="width: 100%; padding: 0.1em">
                <div style="width:60%; text-align: left; padding: 0.5em; border: 0px solid; float: left; border-radius: 5px;">
                    ...
                    <div style="font-size: 8pt; margin-top: 0.2em">
                        <span>O presente estracto é confedencial.</span>
                    </div>
                </div>                
