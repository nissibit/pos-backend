...
<div class="card">
    ...
    <div class="card-body">
        <form class="form-horizontal" method="POST" action="{{ route('price.update', $price->id) }}">
            ...
            <div class="row">
                <div class="col-sm-6 form-group input-group-sm">
                    ...
                    <select class="form-control @error('account_id') is-invalid @enderror" name="account_id">
                        ...
                        <option value="{{ $account->id }}" {{ old('account_id', $price->account_id ?? '') == $account->id ? 'selected' : '' }}>  {{ $account->fullname }}</option>                    
                        @endforeach
                    </select>
                    @error('account_id')
            ...
            <div class="row">
                <div class="col-sm-6 form-group input-group-sm">
                    <label for="price" class="control-label">priceo </label>
                    <input id="price" type="text" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ old('price', $price->price ?? '') }}"  >
                    @error('price')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="col-sm-6 form-group input-group-sm">
                    ...
                    <input id="debit" type="text" class="form-control @error('debit') is-invalid @enderror" name="debit" value="{{ old('debit', $price->debit ?? '') }}"  >
                    @error('debit')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="row">
                <div class="col-sm-6 form-group input-group-sm">
                    ...
                    <input id="balance" type="text" class="form-control @error('balance') is-invalid @enderror" name="balance" value="{{ old('balance', $price->balance ?? '') }}"  >
                    @error('balance')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="col-sm-6 form-group input-group-sm">
                    ...
                    <input id="discount" type="text" class="form-control @error('discount') is-invalid @enderror" name="discount" value="{{ old('discount', $price->discount ?? '') }}"  >
                    @error('discount')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
