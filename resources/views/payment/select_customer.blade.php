                ...
                <tr>
                    ...
                    <td>
                        <div class="form-inline">
                            <form id="account_search" role="form" autocomplete="off" action="{{ route('payment.create') }}" method="get" class="m-sm-1">
                            ...
                            <div class="btn-group-sm">
                                <a href="{{ route('payment.by_account', $account->id) }}" class="btn btn-outline-primary  ml-1">
