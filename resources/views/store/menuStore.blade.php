<div class="row">
    <div class="form-group col btn-group-sm">
        <a href="{{ route('store.create') }}" class="btn btn-outline-secondary">
            <i class="fas fa-plus-circle"> criar</i>
        </a> 
        <a href="{{ route('store.index') }}" class="btn btn-outline-secondary  ml-1">
            <i class="fas fa-list"> listar</i>
        </a>
        <a href="{{ route('transference.index') }}" class="btn btn-outline-secondary  ml-1">
            <i class="fas fa-exchange-alt"> Transferências</i>
        </a>
    </div>
