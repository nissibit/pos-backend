        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="tab_1" aria-labelledby="nav-contact-tab">
                <div class="row">
                    ...
                    <div class="col">
                        <iframe src="{{  route('report.loan', ['id' => $loan->id]) }}" width="100%" height="700px">
                        </iframe>
                    </div>
                </div>
            </div>
            <div role="tabpanel" class="tab-pane" id="tab_2" aria-labelledby="nav-contact-tab">@include('loan.items')</div>
        </div>
    </div>
</div>
@endsection
