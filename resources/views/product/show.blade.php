...
<div class="row">
    <div class="col-sm-2 text-center">
        ...
        <p>
            ...
            <small>Entidade desde <?php echo $product->created_at->diffForHumans(); ?></small>
        </p>
        @can('audit_product')
    ...
    <div class="col border-primary">
        <ul class="nav nav-tabs" id="pills-tab" role="tablist">
            ...
            @can("menu_relation")
            <li class="nav-item">
                <a href="#tab_5" data-toggle="tab" class="nav-item nav-link"><i class="fa fa-arrow-up text-dark"></i> Relação</a>
            </li>
            @endcan
            @can("menu_statistic")
            <li class="nav-item"><a href="#tab_6" data-toggle="tab" class="nav-item nav-link"><i class="fas fa-chart-bar text-dark"></i> Estatística</a></li>                
            @endcan
        </ul>
        ...
        <div class="tab-content">
            ...
            @endcan
            <div role="tabpanel" class="tab-pane" id="tab_5" aria-labelledby="nav-contact-tab">@include('product.parents')</div>
            <div role="tabpanel" class="tab-pane" id="tab_6" aria-labelledby="nav-contact-tab">@include('product.statistic')</div>
        </div>
        <!-- /.tab-content -->
    </div>
</div>
